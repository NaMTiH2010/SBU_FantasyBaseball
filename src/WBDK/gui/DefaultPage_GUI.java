 ...
 * @author MatthewLuce
 */
public class DefaultPage_GUI implements WBDK_DataView {
    ...
    private void initFileToolbar() {
        ...
        loadDraftButton = initChildButton(fileToolbarPane, WBDK_PropertyType.LOAD_COURSE_ICON, WBDK_PropertyType.LOAD_COURSE_TOOLTIP, false);
